    ...
    emptyState(
        ...
        if(colspan){
            return `
                <tr>
                    <td colspan="${colspan}"
                        class="px-6 py-10 text-center text-xs 2xl:text-sm text-slate-500">
        ...
        return `
            <div class="rounded-md border border-slate-200 bg-white p-10 text-center text-xs 2xl:text-sm text-slate-500">
                ${this.escapeHtml(message)}
            </div>
        `;
    },
                    ...
                    ${
                        start>1
                            ?`
                                ...
                                ${
                                    start>2
                                        ?'<span class="px-1 text-xs 2xl:text-sm text-slate-500">...</span>'
                                        :''
                                }
                            `
                            :''
