...
window.AdminUI={
    ...
    */
    ...
    | Optional helper.
    |
    | AdminUI.validateRequired('investmentForm',{
    ...
    */
    ...
    formatDate(value,withTime=false){
        ...
        /*
        |--------------------------------------------------------------------------
        | Prevent timezone shift for Y-m-d strings
        |--------------------------------------------------------------------------
        */
...
/*
|--------------------------------------------------------------------------
| Global Field Validation Auto-Clear
|--------------------------------------------------------------------------
|
| Any form that uses:
|
...
| can call:
|
| AdminUI.bindFieldValidation('formId');
|
|--------------------------------------------------------------------------
*/
