    ...
    <div class="flex flex-col gap-4 rounded-lg border border-slate-200 bg-white p-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <button
                ...
                class="inline-flex h-9 items-center justify-center gap-2 rounded-md bg-indigo-600 px-4 text-sm font-semibold text-white transition hover:bg-indigo-700">
...
<div
    ...
    <div class="flex max-h-[92vh] w-full max-w-xl flex-col overflow-hidden rounded-lg border border-slate-200 bg-white shadow-2xl">
        ...
        <form id="purchaseForm" class="flex min-h-0 flex-1 flex-col" novalidate data-js-validation="1">
            ...
            <div class="flex shrink-0 justify-end gap-2 border-t border-slate-200 bg-slate-50/50 px-5 py-4">
                ...
                <button
                    id="purchaseButton"
                    type="submit"
                    class="h-9 rounded-md bg-indigo-600 px-4 text-sm font-semibold text-white transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-60">
                    Submit Purchase
                </button>
...
function shareInformationItem(
    ...
    return`
        <div class="border-b border-slate-100 px-5 py-4 sm:border-r">
            ...
            <div class="mt-1.5 break-words text-sm font-semibold text-slate-700">
                ${
                    raw
                        ?value
                        :escapeShareHtml(
