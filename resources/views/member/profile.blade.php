        ...
        <div class="grid grid-cols-2 gap-3 md:grid-cols-4">
            <div class="rounded-md border border-slate-200 bg-white px-5 py-2">
                <div class="flex items-center justify-between gap-3">
                    <div>
                        <p class="text-[11px] text-slate-500">Member Code</p>
            ...
            <div class="rounded-md border border-slate-200 bg-white px-5 py-2">
                <div class="flex items-center justify-between gap-3">
                    <div>
                        <p class="text-[11px] text-slate-500">Joining Date</p>
            ...
            <div class="rounded-md border border-slate-200 bg-white px-5 py-2">
                <div class="flex items-center justify-between gap-3">
                    <div>
                        <p class="text-[11px] text-slate-500">Account Status</p>
            ...
            <div class="rounded-md border border-slate-200 bg-white xl:col-span-2">
                <div class="flex items-center gap-3 border-b border-slate-200 px-5 py-4">
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-slate-500">Basic personal and contact details</p>
                    </div>
                </div>

                <div class="grid grid-cols-1 gap-px bg-slate-200 sm:grid-cols-2">
                    <div class="bg-white p-5">
                        <p class="text-[10px] font-medium uppercase tracking-wide text-slate-500">Full Name</p>
                        <p id="personalName" class="mt-1.5 text-base font-semibold text-slate-700">-</p>
                    </div>
                    <div class="bg-white p-5">
                        <p class="text-[10px] font-medium uppercase tracking-wide text-slate-500">Email</p>
                        <p id="personalEmail" class="mt-1.5 break-all text-base font-semibold text-slate-700">-</p>
                    </div>
                    <div class="bg-white p-5">
                        <p class="text-[10px] font-medium uppercase tracking-wide text-slate-500">Phone</p>
                        <p id="phone" class="mt-1.5 text-base font-semibold text-slate-700">-</p>
                    </div>
                    <div class="bg-white p-5">
                        <p class="text-[10px] font-medium uppercase tracking-wide text-slate-500">Alternate Phone</p>
                        <p id="alternatePhone" class="mt-1.5 text-base font-semibold text-slate-700">-</p>
                    </div>
                    <div class="bg-white p-5">
                        <p class="text-[10px] font-medium uppercase tracking-wide text-slate-500">Date of Birth</p>
                        <p id="dateOfBirth" class="mt-1.5 text-base font-semibold text-slate-700">-</p>
                    </div>
                    <div class="bg-white p-5">
                        <p class="text-[10px] font-medium uppercase tracking-wide text-slate-500">Gender</p>
            ...
            <div class="rounded-md border border-slate-200 bg-white">
                <div class="flex items-center gap-3 border-b border-slate-200 px-5 py-4">
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-slate-500">Association membership details</p>
                    </div>
                </div>
        ...
        <div class="rounded-md border border-slate-200 bg-white">
            <div class="flex items-center gap-3 border-b border-slate-200 px-5 py-4">
                ...
                <div>
                    ...
                    <p class="text-[11px] text-slate-500">Residential location details</p>
                </div>
            </div>

            <div class="grid grid-cols-1 gap-px bg-slate-200 md:grid-cols-3">
                <div class="bg-white p-5 md:col-span-3">
                    <p class="text-[10px] font-medium uppercase tracking-wide text-slate-500">Address</p>
                    <p id="address" class="mt-1.5 text-base font-semibold leading-6 text-slate-700">-</p>
                </div>
                <div class="bg-white p-5">
                    <p class="text-[10px] font-medium uppercase tracking-wide text-slate-500">City</p>
                    <p id="city" class="mt-1.5 text-base font-semibold text-slate-700">-</p>
                </div>
                <div class="bg-white p-5">
                    <p class="text-[10px] font-medium uppercase tracking-wide text-slate-500">District</p>
                    <p id="district" class="mt-1.5 text-base font-semibold text-slate-700">-</p>
                </div>
                <div class="bg-white p-5">
                    <p class="text-[10px] font-medium uppercase tracking-wide text-slate-500">Mobile</p>
    ...
    <div class="max-h-[92vh] w-full max-w-2xl overflow-y-auto rounded-md border border-slate-200 bg-white shadow-xl">
        <div class="sticky top-0 z-10 flex items-center justify-between border-b border-slate-200 bg-white px-5 py-4">
            <div>
                ...
                <p class="mt-0.5 text-sm text-slate-500">Update your profile information.</p>
            </div>
            <button type="button" onclick="closeEditProfile()" class="flex h-8 w-8 items-center justify-center rounded-md text-slate-500 transition hover:bg-slate-100 hover:text-slate-600">
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="flex flex-col gap-4 rounded-md border border-slate-200 bg-slate-50 p-4 sm:flex-row sm:items-center">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <p class="mt-2 text-[11px] text-slate-500">JPG, PNG or WEBP. Maximum 2 MB.</p>
...
async function loadMemberProfile(){
    ...
    try{
        ...
        loading.innerHTML=`
            ...
            <p class="mt-1 text-sm text-slate-500">${escapeProfileHtml(error?.data?.message??error?.message??'Please refresh the page and try again.')}</p>
