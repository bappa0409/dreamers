    ...
    <div class="flex flex-col gap-4 rounded-md border border-slate-200 bg-white px-5 py-4 md:flex-row md:items-center md:justify-between">
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-slate-500">Messages submitted from the website contact form.</p>
            </div>
        </div>

        <span id="unreadBadge" class="hidden w-fit items-center gap-1.5 rounded-md bg-red-50 px-3 py-1.5 text-xs font-semibold text-red-600">
