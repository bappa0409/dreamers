...
<div class="space-y-4">
    ...
    <div class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="grid gap-x-6 gap-y-4 sm:grid-cols-2 lg:grid-cols-5">
            <div>
                <p class="mb-1.5 text-[10px] font-bold uppercase tracking-wide text-slate-500">শুরুর কথা</p>
            ...
            <div>
                <p class="mb-1.5 text-[10px] font-bold uppercase tracking-wide text-slate-500">টাকার প্রবাহ (মডিউল অনুযায়ী)</p>
                <ul class="space-y-1 text-xs 2xl:text-sm">
            ...
            <div>
                <p class="mb-1.5 text-[10px] font-bold uppercase tracking-wide text-slate-500">প্রভাব ও রেফারেন্স</p>
                <ul class="space-y-1 text-xs 2xl:text-sm">
            ...
            <div>
                <p class="mb-1.5 text-[10px] font-bold uppercase tracking-wide text-slate-500">রিপোর্ট ও রসিদ</p>
                <ul class="space-y-1 text-xs 2xl:text-sm">
            ...
            <div>
                <p class="mb-1.5 text-[10px] font-bold uppercase tracking-wide text-slate-500">অন্যান্য</p>
                <ul class="space-y-1 text-xs 2xl:text-sm">
    ...
    <div id="subscription" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
            <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">Journal — Type: subscription_due</p>
            <table class="w-full text-xs 2xl:text-sm">
                <tbody>
        ...
        <div class="mt-3 flex flex-wrap gap-3">
            <div class="min-w-[220px] flex-1 overflow-hidden rounded-md border border-slate-200">
                ...
                <div class="flex divide-x divide-slate-200">
                    <div class="w-1/2 p-2">
                        <p class="mb-1 text-[9px] font-bold uppercase text-slate-500">Debit</p>
                    ...
                    <div class="w-1/2 p-2">
                        <p class="mb-1 text-[9px] font-bold uppercase text-slate-500">Credit</p>
                    </div>
                </div>
        ...
        <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
            <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">Journal — Type: subscription_fine</p>
            <table class="w-full text-xs 2xl:text-sm">
                <tbody>
        ...
        <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
            <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">Journal — Type: subscription_payment</p>
            <table class="w-full text-xs 2xl:text-sm">
                <tbody>
    ...
    <div id="charges" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="mt-3 grid gap-3 sm:grid-cols-2">
            <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">Journal — Charge ধার্য করার সময়</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
            ...
            <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">Journal — Charge Payment গ্রহণের সময়</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
    ...
    <div id="loans" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
            <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">Journal — Loan Disbursement</p>
            <table class="w-full text-xs 2xl:text-sm">
                <tbody>
        ...
        <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
            <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">Journal — Loan Repayment (মূল + সুদ)</p>
            <table class="w-full text-xs 2xl:text-sm">
                <tbody>
        ...
        <div class="mt-3 rounded-md border border-violet-200 bg-violet-50 px-4 py-3 text-xs 2xl:text-sm leading-5 text-violet-800">
            ...
            <div class="mt-2 rounded-md border border-dashed border-violet-300 bg-white p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">দিন ১ — ঋণ প্রদান</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
            ...
            <div class="mt-2 rounded-md border border-dashed border-violet-300 bg-white p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">১ম মাস কিস্তি</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
    ...
    <div id="investments" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="grid gap-3 sm:grid-cols-2">
            <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">Journal — বিনিয়োগ করার সময়</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
            ...
            <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">Journal — রিটার্ন পাওয়ার সময়</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
        ...
        <div class="mt-3 rounded-md border border-violet-200 bg-violet-50 px-4 py-3 text-xs 2xl:text-sm leading-5 text-violet-800">
            ...
            <div class="mt-2 rounded-md border border-dashed border-violet-300 bg-white p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">বিনিয়োগ করার সময়</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
            ...
            <div class="mt-2 rounded-md border border-dashed border-violet-300 bg-white p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">১ বছর পর — মূলধন + মুনাফা একসাথে ফেরত</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
    ...
    <div id="shares" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="grid gap-3 sm:grid-cols-2">
            <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">Journal — শেয়ার ক্রয়</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
            ...
            <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">Journal — সদস্য Exit / শেয়ার ফেরত</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
    ...
    <div id="assets" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="mt-3 rounded-md border border-violet-200 bg-violet-50 px-4 py-3 text-xs 2xl:text-sm leading-5 text-violet-800">
            ...
            <div class="mt-2 rounded-md border border-dashed border-violet-300 bg-white p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">ক্রয়ের সময়</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
            ...
            <div class="mt-2 rounded-md border border-dashed border-violet-300 bg-white p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">প্রতি মাসে</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
    ...
    <div id="teller" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="mt-3 grid gap-3 sm:grid-cols-2">
            <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">Journal — Teller Receive</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
            ...
            <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">Journal — Teller Payment</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
    ...
    <div id="income-expense" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="mt-3 grid gap-3 sm:grid-cols-2">
            <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">Journal — Income Entry</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
            ...
            <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">Journal — Expense Entry</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
        ...
        <div class="mt-3 rounded-md border border-violet-200 bg-violet-50 px-4 py-3 text-xs 2xl:text-sm leading-5 text-violet-800">
            ...
            <div class="mt-2 rounded-md border border-dashed border-violet-300 bg-white p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">অনুদান গ্রহণ</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
            ...
            <div class="mt-2 rounded-md border border-dashed border-violet-300 bg-white p-3">
                <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-500">অফিস ভাড়া পরিশোধ</p>
                <table class="w-full text-xs 2xl:text-sm">
                    <tbody>
    ...
    {{-- Footer --}}
    <p class="pt-2 text-center text-[11px] text-slate-500">
