...
<div class="space-y-4">
    ...
    <div class="flex flex-col gap-3 rounded-md border border-slate-200 bg-white px-5 py-4 md:flex-row md:items-center md:justify-between">
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-slate-500">প্রতিটি মডিউলে টাকা কীভাবে ডেবিট-ক্রেডিট আকারে জার্নালে পোস্ট হয় — বাস্তব উদাহরণসহ ধাপে ধাপে ব্যাখ্যা।</p>
            </div>
        </div>
    ...
    <div class="rounded-md bg-gradient-to-br from-indigo-600 to-violet-600 px-6 py-8 text-white shadow-sm">
        ...
        <p class="mt-2 max-w-2xl text-xs leading-6 text-indigo-100">
    ...
    <div id="overview" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="mt-3 rounded-md border border-indigo-200 bg-indigo-50/50 px-4 py-3 text-xs leading-5 text-indigo-700">
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">হিসাবের ৫টি মূল শ্রেণি (Account Types)</h3>
        ...
        <div class="mt-3 rounded-md border border-emerald-200 bg-emerald-50 px-4 py-3 text-xs leading-5 text-emerald-700">
    ...
    <div id="accrual" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="mt-3 rounded-md border border-violet-200 bg-violet-50 px-4 py-3 text-xs leading-5 text-violet-800">
    ...
    <div id="coa" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="mt-3 grid gap-4 sm:grid-cols-2">
            <div class="space-y-3">
                <div>
                    <h4 class="mb-1.5 text-xs font-bold text-indigo-600">1000 — Assets</h4>
                    <div class="overflow-x-auto rounded-md border border-slate-200">
                        <table class="w-full text-xs">
                            <tbody class="divide-y divide-slate-100">
                ...
                <div>
                    <h4 class="mb-1.5 text-xs font-bold text-indigo-600">2000 — Liabilities</h4>
                    <div class="overflow-x-auto rounded-md border border-slate-200">
                        <table class="w-full text-xs">
                            <tbody class="divide-y divide-slate-100">
                ...
                <div>
                    <h4 class="mb-1.5 text-xs font-bold text-indigo-600">3000 — Equity</h4>
                    <div class="overflow-x-auto rounded-md border border-slate-200">
                        <table class="w-full text-xs">
                            <tbody class="divide-y divide-slate-100">
            ...
            <div class="space-y-3">
                <div>
                    <h4 class="mb-1.5 text-xs font-bold text-indigo-600">4000 — Income</h4>
                    <div class="overflow-x-auto rounded-md border border-slate-200">
                        <table class="w-full text-xs">
                            <tbody class="divide-y divide-slate-100">
                ...
                <div>
                    <h4 class="mb-1.5 text-xs font-bold text-indigo-600">5000 — Expense</h4>
                    <div class="overflow-x-auto rounded-md border border-slate-200">
                        <table class="w-full text-xs">
                            <tbody class="divide-y divide-slate-100">
    ...
    <div id="engine" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <div class="rounded-md border border-slate-200 bg-white p-3">
                ...
                <p class="text-xs text-slate-600"><b class="text-slate-800">ব্যালেন্স যাচাই</b><br>মোট Debit = মোট Credit না হলে এন্ট্রি বাতিল হয়ে যায়।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-white p-3">
                ...
                <p class="text-xs text-slate-600"><b class="text-slate-800">ইউনিক নাম্বার</b><br>প্রতিটি ভাউচারে অটো-জেনারেটেড Transaction No বসে।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-white p-3">
                ...
                <p class="text-xs text-slate-600"><b class="text-slate-800">Idempotency</b><br>একই পেমেন্ট/ইভেন্টের জন্য একাধিকবার ভুলে ডাবল-এন্ট্রি হওয়া আটকানো হয়।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-white p-3">
                ...
                <p class="text-xs text-slate-600"><b class="text-slate-800">তাৎক্ষণিক Posted</b><br>বেশিরভাগ স্বয়ংক্রিয় জার্নাল সরাসরি <span class="rounded-full bg-emerald-100 px-2 py-0.5 text-[10px] font-bold text-emerald-700">Posted</span> স্ট্যাটাসে সেভ হয়।</p>
            </div>
        </div>

        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">স্ট্যাটাস</h3>
        <div class="overflow-x-auto rounded-md border border-slate-200">
            <table class="w-full text-xs">
                <thead class="border-b border-slate-200 bg-slate-50">
                    <tr>
        ...
        <div class="mt-3 rounded-md border border-amber-200 bg-amber-50 px-4 py-3 text-xs leading-5 text-amber-800">
    ...
    <div id="approval-workflow" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="mt-3 grid gap-3 sm:grid-cols-2">
            <div class="rounded-md border border-emerald-200 bg-emerald-50 px-4 py-3 text-xs leading-5 text-emerald-700">
            ...
            <div class="rounded-md border border-amber-200 bg-amber-50 px-4 py-3 text-xs leading-5 text-amber-800">
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">কোন মডিউল/অ্যাকশনগুলোর জন্য এই সুইচ কাজ করে</h3>
        <p class="mb-2 text-xs leading-6 text-slate-600">
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">Approve / Reject / Cancel হলে কী হয়</h3>
        <div class="grid gap-3 sm:grid-cols-3">
            <div class="rounded-md border border-slate-200 bg-white p-3">
                <span class="mb-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-[11px] font-bold text-white">১</span>
                <p class="text-xs text-slate-600"><b class="text-slate-800">Approve</b><br>একাধিক ধাপ (স্টেপ) থাকলে ক্রমান্বয়ে পরের Approver-কে নোটিফাই করা হয়; সর্বশেষ ধাপ Approve হলেই কেবল আসল পোস্টিং (journal/verify/activate) চলে।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-white p-3">
                <span class="mb-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-[11px] font-bold text-white">২</span>
                <p class="text-xs text-slate-600"><b class="text-slate-800">Reject</b><br>যেকোনো ধাপে Reject হলে সাথে সাথে পুরো রিকোয়েস্ট বাতিল; সংশ্লিষ্ট এন্ট্রি (যেমন পেমেন্ট, চার্জ, অ্যাসেট, জার্নাল) "Rejected" স্ট্যাটাসে থেকে যায়, কোনো পোস্টিং হয় না।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-white p-3">
                <span class="mb-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-[11px] font-bold text-white">৩</span>
                <p class="text-xs text-slate-600"><b class="text-slate-800">Cancel</b><br>রিকোয়েস্টকারী নিজে অনুমোদনের আগে রিকোয়েস্টটি Cancel করতে পারেন — সংশ্লিষ্ট এন্ট্রি নিষ্ক্রিয়/বাতিল অবস্থায় চলে যায়, ভবিষ্যতে আবার নতুন করে সাবমিট করতে হয়।</p>
            </div>
        </div>
    ...
    <div id="subscription" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <div class="rounded-md border border-slate-200 bg-white p-3">
                <span class="mb-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-[11px] font-bold text-white">১</span>
                <p class="text-xs text-slate-600">সদস্য Approve হওয়ার সময় / প্রতি মাসের শুরুতে সিস্টেম একটি <b>Due</b> তৈরি করে ও জার্নাল পোস্ট করে।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-white p-3">
                <span class="mb-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-[11px] font-bold text-white">২</span>
                <p class="text-xs text-slate-600">Due Day পার হয়ে গেলে "Late Fine" সেটিং চালু থাকলে আলাদা জার্নালে ফাইন যোগ হয়।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-white p-3">
                <span class="mb-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-[11px] font-bold text-white">৩</span>
                <p class="text-xs text-slate-600">সদস্য নিজের পোর্টাল থেকে <b>Pay</b>-তে গিয়ে টাকা জমার তথ্য সাবমিট করেন — এই ধাপে কোনো জার্নাল হয় না।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-white p-3">
                <span class="mb-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-[11px] font-bold text-white">৪</span>
                <p class="text-xs text-slate-600">অ্যাডমিন <code class="rounded bg-slate-100 px-1 py-0.5 font-mono text-[10px] text-indigo-700">Finance → Subscription Payments</code> থেকে <b>Verify</b> করলে তবেই Receivable → Cash জার্নাল পোস্ট হয়।</p>
            </div>
        </div>

        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">ব্যবহৃত অ্যাকাউন্ট</h3>
        <div class="overflow-x-auto rounded-md border border-slate-200">
            <table class="w-full text-xs">
                <thead class="border-b border-slate-200 bg-slate-50">
                    <tr>
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">ধাপ ১ — Due তৈরি (Accrue)</h3>
        ...
        <div class="mt-3 flex flex-wrap gap-3">
            <div class="min-w-[220px] flex-1 overflow-hidden rounded-md border border-slate-200">
                <div class="bg-slate-800 px-3 py-1.5 text-xs font-bold text-white">Accounts Receivable (Asset)</div>
                ...
                <div class="flex justify-between bg-slate-50 px-3 py-1.5 text-xs font-bold text-slate-700"><span>Balance</span><span>৳1,000 Dr</span></div>
            </div>
            <div class="min-w-[220px] flex-1 overflow-hidden rounded-md border border-slate-200">
                <div class="bg-slate-800 px-3 py-1.5 text-xs font-bold text-white">Subscription Income</div>
                <div class="flex divide-x divide-slate-200">
                    <div class="w-1/2 p-2">
                        <p class="mb-1 text-[9px] font-bold uppercase text-slate-400">Debit</p>
                    </div>
                ...
                <div class="flex justify-between bg-slate-50 px-3 py-1.5 text-xs font-bold text-slate-700"><span>Balance</span><span>৳1,000 Cr</span></div>
            </div>
        </div>
        <div class="mt-3 rounded-md border border-indigo-200 bg-indigo-50/50 px-4 py-3 text-xs leading-5 text-indigo-700">
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">ধাপ ২ — Late Fine প্রয়োগ</h3>
        <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">ধাপ ৩ — Payment Submit (কোনো জার্নাল নেই)</h3>
        <div class="rounded-md border border-amber-200 bg-amber-50 px-4 py-3 text-xs leading-5 text-amber-800">
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">ধাপ ৪ — Payment Verify (আংশিক, ৳600)</h3>
        <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
        ...
        <div class="mt-3 flex flex-wrap gap-3">
            <div class="min-w-[220px] flex-1 overflow-hidden rounded-md border border-slate-200">
                <div class="bg-slate-800 px-3 py-1.5 text-xs font-bold text-white">Accounts Receivable</div>
                <div class="flex divide-x divide-slate-200">
                    <div class="w-1/2 p-2">
                        <p class="mb-1 text-[9px] font-bold uppercase text-slate-400">Debit</p>
                ...
                <div class="flex justify-between bg-slate-50 px-3 py-1.5 text-xs font-bold text-slate-700"><span>Balance</span><span>৳450 Dr</span></div>
            </div>
            <div class="min-w-[220px] flex-1 overflow-hidden rounded-md border border-slate-200">
                <div class="bg-slate-800 px-3 py-1.5 text-xs font-bold text-white">Cash / Bank</div>
                <div class="flex divide-x divide-slate-200">
                    <div class="w-1/2 p-2">
                        <p class="mb-1 text-[9px] font-bold uppercase text-slate-400">Debit</p>
                        <div class="flex justify-between border-b border-dotted border-slate-200 py-0.5 text-[11px] text-slate-600"><span>Payment verified</span><span>600</span></div>
                ...
                <div class="flex justify-between bg-slate-50 px-3 py-1.5 text-xs font-bold text-slate-700"><span>Balance</span><span>৳600 Dr</span></div>
            </div>
        </div>
        <div class="mt-3 rounded-md border border-indigo-200 bg-indigo-50/50 px-4 py-3 text-xs leading-5 text-indigo-700">
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">ধাপ ৫ — Payment Verify (বাকি ৳450) → পুরোপুরি Paid</h3>
        <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
            <p class="mb-2 text-[10px] font-bold uppercase tracking-wide text-slate-400">Journal — Type: subscription_payment</p>
            <table class="w-full text-xs">
                <tbody>
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">Payment Reject হলে কী হয়</h3>
        <ul class="ml-4 list-disc space-y-1 text-xs leading-6 text-slate-600">
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">সম্পূর্ণ টাইমলাইন — নাম্বার সহ</h3>
        <div class="ml-2 space-y-4 border-l-2 border-indigo-200 pl-4">
            <div class="relative">
                ...
                <p class="text-xs font-bold text-slate-800">Member Approve → Due Generate</p>
                <p class="text-xs text-slate-500">Receivable +1,000 · Subscription Income +1,000 · Cash অপরিবর্তিত</p>
            </div>
            <div class="relative">
                <span class="absolute -left-[21px] top-1 h-2.5 w-2.5 rounded-full bg-indigo-600 ring-4 ring-indigo-100"></span>
                <p class="text-[10px] font-bold uppercase tracking-wide text-indigo-600">দিন ১২ (due day পার)</p>
                <p class="text-xs font-bold text-slate-800">Late Fine প্রয়োগ (+৳50)</p>
                <p class="text-xs text-slate-500">Receivable +50 (মোট 1,050) · Fine Income +50</p>
            </div>
            <div class="relative">
                <span class="absolute -left-[21px] top-1 h-2.5 w-2.5 rounded-full bg-indigo-600 ring-4 ring-indigo-100"></span>
                <p class="text-[10px] font-bold uppercase tracking-wide text-indigo-600">দিন ১৫</p>
                <p class="text-xs font-bold text-slate-800">৳600 পেমেন্ট সাবমিট + Verify</p>
                <p class="text-xs text-slate-500">Cash +600 · Receivable −600 (বাকি 450) · status: partial</p>
            </div>
            <div class="relative">
                <span class="absolute -left-[21px] top-1 h-2.5 w-2.5 rounded-full bg-indigo-600 ring-4 ring-indigo-100"></span>
                <p class="text-[10px] font-bold uppercase tracking-wide text-indigo-600">দিন ২০</p>
                <p class="text-xs font-bold text-slate-800">বাকি ৳450 পেমেন্ট সাবমিট + Verify</p>
                <p class="text-xs text-slate-500">Cash +450 · Receivable −450 (বাকি 0) · status: paid ✅</p>
            </div>
        </div>
    ...
    <div id="loans" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <h3 class="mb-2 text-xs font-bold text-slate-800">ঋণ প্রদান (Disbursement)</h3>
        <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">কিস্তি পরিশোধ (Repayment)</h3>
        <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
    ...
    <div id="assets" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <h3 class="mb-2 text-xs font-bold text-slate-800">সম্পদ ক্রয় (Asset Purchase)</h3>
        <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
            <table class="w-full text-xs">
                <tbody>
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">মাসিক/বার্ষিক অবচয় (Depreciation)</h3>
        <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
            <table class="w-full text-xs">
                <tbody>
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">সম্পদ বিক্রয়/অপসারণ (Disposal / Sale)</h3>
        <div class="rounded-md border border-dashed border-slate-300 bg-slate-50/60 p-3">
            <table class="w-full text-xs">
                <tbody>
    ...
    <div id="income-expense" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <p class="mt-3 text-xs leading-6 text-slate-600">ভুল এন্ট্রি করা হলে "Reverse"/"Cancel" অপশন দিয়ে বিপরীত জার্নাল পোস্ট করা যায় (মূল এন্ট্রি ইতিহাসে থেকে যায়)।</p>
    </div>
    ...
    <div id="manual-journal" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">নিয়ম</h3>
        <ul class="ml-4 list-disc space-y-1 text-xs leading-6 text-slate-600">
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">রিভার্সাল (Reverse Journal)</h3>
        <p class="text-xs leading-6 text-slate-600">
    ...
    <div id="statements" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="grid gap-3 sm:grid-cols-2">
            <div class="rounded-md border border-slate-200 bg-slate-50/60 p-3">
                <h3 class="mb-1 text-xs font-bold text-slate-800">Trial Balance</h3>
                <p class="text-xs leading-6 text-slate-600">প্রতিটা জার্নালের Debit = Credit থাকে বলে ট্রায়াল ব্যালেন্স সবসময় মিলে যায়। প্রতিটা এন্ট্রি অন্তত ২ লাইনের (এক Debit, এক Credit) — কোনোটাতেই ভারসাম্য নষ্ট হয় না।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-slate-50/60 p-3">
                <h3 class="mb-1 text-xs font-bold text-slate-800">Profit &amp; Loss</h3>
                <p class="text-xs leading-6 text-slate-600">Subscription Income, Fine Income, Loan Interest Income ইত্যাদি সবকিছু <b>due/ইভেন্ট তৈরি হওয়ার দিনেই</b> P&amp;L-এ যোগ হয়ে যায় — সেই মাসের প্রফিটে প্রভাব ফেলে, পেমেন্ট আসুক বা না আসুক।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-slate-50/60 p-3">
                <h3 class="mb-1 text-xs font-bold text-slate-800">Balance Sheet</h3>
                <p class="text-xs leading-6 text-slate-600">যতদিন due unpaid/partial থাকে, ওই টাকা Balance Sheet-এ <b>Accounts Receivable</b> (Asset) হিসেবে দেখাবে। Payment verify হলে সেটা Receivable থেকে সরে <b>Cash/Bank</b> (Asset)-এ চলে যায় — মোট Asset-এর পরিমাণ বদলায় না, শুধু ভেতরের গঠন বদলায়।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-slate-50/60 p-3">
                <h3 class="mb-1 text-xs font-bold text-slate-800">Cash Flow (বাস্তবে)</h3>
                <p class="text-xs leading-6 text-slate-600">প্রকৃত টাকার নড়াচড়া হয় শুধুই Payment Verify, Loan Disbursement/Repayment, বা সরাসরি Cash/Bank জড়িত এন্ট্রির সময় — শুধু Due তৈরি বা Fine বসানোর সময় Cash Flow-তে কিছুই দেখাবে না।</p>
            </div>
        </div>
    </div>
    ...
    <div id="appendix" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <p class="mb-2 text-xs leading-6 text-slate-600">দ্রুত রেফারেন্সের জন্য সব মডিউলের ডেবিট/ক্রেডিট এক টেবিলে:</p>
    ...
    <div id="reports" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <p class="mt-3 text-xs leading-6 text-slate-600">প্রায় প্রতিটি রিপোর্ট থেকে PDF/Excel এক্সপোর্ট এবং প্রিন্ট করার সুবিধা আছে।</p>
    </div>
    ...
    <div id="receipts" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <h3 class="mb-2 text-xs font-bold text-slate-800">ক) সদস্যের পেমেন্ট রসিদ (Member Payment Receipt)</h3>
        <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <div class="rounded-md border border-slate-200 bg-white p-3">
                <span class="mb-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-[11px] font-bold text-white">১</span>
                <p class="text-xs text-slate-600">সদস্য <code class="rounded bg-slate-100 px-1 py-0.5 font-mono text-[10px] text-indigo-700">Member → Monthly Dues → Pay</code>-তে গিয়ে পেমেন্ট সাবমিট করেন।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-white p-3">
                <span class="mb-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-[11px] font-bold text-white">২</span>
                <p class="text-xs text-slate-600">সফল হলে সাথে সাথে একটি <b>Payment Receipt</b> পপ-আপ দেখানো হয়।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-white p-3">
                <span class="mb-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-[11px] font-bold text-white">৩</span>
                <p class="text-xs text-slate-600">রসিদে থাকে: Receipt No, তারিখ, সদস্যের নাম/কোড, মাস, পেমেন্ট মেথড, রেফারেন্স, স্ট্যাটাস ও পরিমাণ।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-white p-3">
                <span class="mb-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-[11px] font-bold text-white">৪</span>
                <p class="text-xs text-slate-600"><b>Print Receipt</b> বাটনে ক্লিক করলে প্রিন্ট-উপযোগী ফরম্যাটে নতুন ট্যাবে খুলবে।</p>
            </div>
        </div>
        <div class="mt-3 rounded-md border border-amber-200 bg-amber-50 px-4 py-3 text-xs leading-5 text-amber-800">
            <p class="mb-1 font-bold">মনে রাখবেন</p>
        ...
        <h3 class="mb-2 mt-4 text-xs font-bold text-slate-800">খ) অ্যাডমিন জার্নাল ভাউচার (Journal Voucher Print)</h3>
        <div class="grid gap-3 sm:grid-cols-3">
            <div class="rounded-md border border-slate-200 bg-white p-3">
                <span class="mb-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-[11px] font-bold text-white">১</span>
                <p class="text-xs text-slate-600"><code class="rounded bg-slate-100 px-1 py-0.5 font-mono text-[10px] text-indigo-700">Finance → Journal Entries</code>-এ গিয়ে যেকোনো এন্ট্রির <b>View</b>-তে ক্লিক করুন।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-white p-3">
                <span class="mb-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-[11px] font-bold text-white">২</span>
                <p class="text-xs text-slate-600">"Journal Details" মডালে রসিদ আকারে সম্পূর্ণ ভাউচার দেখা যাবে।</p>
            </div>
            <div class="rounded-md border border-slate-200 bg-white p-3">
                <span class="mb-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-indigo-600 text-[11px] font-bold text-white">৩</span>
                <p class="text-xs text-slate-600"><b>Print Receipt</b> বাটনে ক্লিক করলে প্রিন্ট প্রিভিউ খুলবে — যেকোনো প্রিন্টার/PDF-এ সেভ করা যাবে।</p>
            </div>
        </div>
    </div>
    ...
    <div id="faq" class="rounded-md border border-slate-200 bg-white px-5 py-4">
        ...
        <div class="space-y-4">
            <div>
                <h4 class="mb-1 text-xs font-bold text-indigo-600">জার্নাল পোস্ট হচ্ছে না, "Not Balanced" দেখাচ্ছে</h4>
                <p class="text-xs leading-6 text-slate-600">প্রতিটি লাইনের Debit ও Credit যোগফল আলাদাভাবে মিলিয়ে দেখুন — টোটাল Debit অবশ্যই টোটাল Credit-এর সমান হতে হবে। উদাহরণস্বরূপ, ৩ লাইনের একটি ম্যানুয়াল জার্নালে যদি Debit-এ ২,১৫,০০০ এবং Credit-এ ২,১০,০০০ থাকে, তাহলে ৫,০০০ টাকার পার্থক্য খুঁজে বের করে ঠিক করতে হবে।</p>
            </div>
            <div>
                <h4 class="mb-1 text-xs font-bold text-indigo-600">ভুল এন্ট্রি হয়ে গেছে, এখন কী করবো?</h4>
                <p class="text-xs leading-6 text-slate-600">এন্ট্রি এডিট/ডিলিট করা যায় না। <b>Reverse Journal</b> ব্যবহার করে এর বিপরীত এন্ট্রি পোস্ট করুন — এটি হিসাবরক্ষণের নিরাপদ পদ্ধতি। যেমন, ভুলে ৳15,000-এর বদলে ৳51,000 অফিস খরচ এন্ট্রি হয়ে গেলে, প্রথমে পুরো এন্ট্রিটা Reverse করুন, তারপর সঠিক পরিমাণে নতুন এন্ট্রি করুন।</p>
            </div>
            <div>
                <h4 class="mb-1 text-xs font-bold text-indigo-600">সদস্যের পেমেন্ট জার্নালে দেখা যাচ্ছে না</h4>
                <p class="text-xs leading-6 text-slate-600">পেমেন্ট প্রথমে "Pending" অবস্থায় থাকে। <code class="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-[11px] text-indigo-700">Finance → Subscription Payments</code>-এ গিয়ে অ্যাডমিন কর্তৃক Verify করার পরই এটি জার্নালে Posted হিসেবে দেখাবে (দেখুন সেকশন ৬, ধাপ ৩-৪)।</p>
            </div>
            <div>
                <h4 class="mb-1 text-xs font-bold text-indigo-600">টেবিলে হরাইজন্টাল স্ক্রল আসছে কেন, আগে হতো?</h4>
                <p class="text-xs leading-6 text-slate-600">জার্নাল লিস্টের টেবিল থেকে Type ও Source কলাম সরিয়ে Description-এর নিচে ছোট আকারে দেখানো হচ্ছে, এবং টেবিলটি এখন ফিক্সড-লেআউটে সেট করা — ফলে এখন থেকে টেবিলে অতিরিক্ত স্ক্রলবার আসবে না। সম্পূর্ণ তথ্য দেখতে View/রসিদে ক্লিক করুন।</p>
            </div>
            <div>
                <h4 class="mb-1 text-xs font-bold text-indigo-600">রিপোর্টে Total মিলছে না</h4>
                <p class="text-xs leading-6 text-slate-600">Trial Balance রিপোর্টে গিয়ে দেখুন কোনো অ্যাকাউন্টে অস্বাভাবিক ব্যালেন্স আছে কিনা। সাধারণত কোনো Reversal সঠিকভাবে না হলে বা কোনো এন্ট্রি ভুল অ্যাকাউন্টে পোস্ট হলে এমন হতে পারে — এক্ষেত্রে সংশ্লিষ্ট জার্নাল ভাউচার প্রিন্ট করে যাচাই করুন।</p>
            </div>
            <div>
                <h4 class="mb-1 text-xs font-bold text-indigo-600">Due তৈরি হওয়ার সাথে সাথেই কেন Income বেড়ে যায়, টাকা তো এখনো আসেনি?</h4>
                <p class="text-xs leading-6 text-slate-600">এই সিস্টেম Accrual Basis-এ চলে (দেখুন সেকশন ২) — অর্থাৎ পাওনা তৈরি হওয়ার দিনই আয় ধরা হয়, টাকা হাতে আসার দিন নয়। এটা হিসাবশাস্ত্রের স্বীকৃত ও প্রচলিত নিয়ম, ভুল নয়।</p>
            </div>
        </div>
    </div>
