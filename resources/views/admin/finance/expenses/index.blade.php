    ...
    <div class="flex flex-col gap-3 rounded-md border border-slate-200 bg-white px-5 py-4 md:flex-row md:items-center md:justify-between">
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class=" text-xs 2xl:text-sm text-slate-500">Record and manage association expenses.</p>
            </div>
        </div>
        ...
        <div class="flex shrink-0 items-start justify-between gap-4 border-b border-slate-200 px-5 py-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p id="cancelExpenseDescription" class=" text-xs 2xl:text-sm text-slate-500"></p>
                </div>
            </div>
...
function renderExpenseTable(){
    ...
    el.table.innerHTML=expenses.map(item=>`
        <tr class="border-b border-slate-100 last:border-0 hover:bg-slate-50">
            ...
            <td class="px-4 py-3">
                <p class=" text-xs 2xl:text-sm font-medium text-slate-700">
                    ${AdminUI.escapeHtml(
