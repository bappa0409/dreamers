    ...
    <div class="flex flex-col gap-4 rounded-md border border-slate-200 bg-white px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class=" text-xs 2xl:text-sm text-slate-500">Create polls, manage voting periods and review results.</p>
            </div>
        </div>
        ...
        <div class="app-modal-header flex shrink-0 items-start justify-between border-b border-slate-200 px-5 py-3">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class=" text-xs 2xl:text-sm text-slate-500">Create voting options and configure voting period.</p>
                </div>
            </div>
        ...
        <div class="app-modal-header flex shrink-0 items-start justify-between border-b border-slate-200 px-5 py-3">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p id="resultTotal" class=" text-xs 2xl:text-sm text-slate-500"></p>
                </div>
            </div>
