...
<div class="space-y-5">
    ...
    <div class="flex flex-col gap-3 rounded-md border border-slate-200 bg-white p-5  md:flex-row md:items-center md:justify-between">
        ...
        <div class="flex flex-wrap items-center gap-2">
            @if($member)
                <span class="rounded-md bg-slate-100 px-3.5 py-2 text-xs 2xl:text-sm font-semibold text-slate-600">
                    {{ $member->member_code }}
                </span>
            @endif

            <span class="rounded-md bg-indigo-50 px-3.5 py-2 text-xs 2xl:text-sm font-semibold text-indigo-700">
        ...
        <div class="flex flex-col gap-3 rounded-md border border-amber-200 bg-amber-50 p-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="mt-0.5  text-xs 2xl:text-sm text-amber-700">
                        Without a workflow, all requests (member registration, loans, welfare requests, member exits, share purchases, tours, accounts, income, expenses, subscription payments, charges, assets and journal entries) are approved automatically without any approval. You can set up a workflow now, or skip it and continue without one.
                    </p>
                </div>
            </div>
        ...
        <section>
            <div class="mb-3 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-0.5 text-xs 2xl:text-sm text-slate-400">Membership overview</p>
                </div>
                
                <a href="{{ route('admin.members') }}" class="inline-flex w-fit cursor-pointer items-center gap-1.5 rounded-md border border-slate-300 bg-white px-3.5 py-2  text-xs 2xl:text-sm font-semibold text-slate-600 transition hover:bg-slate-50">
            ...
            <div class="rounded-md border border-slate-200 bg-white p-5 ">
                <div class="mb-4 flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-0.5 text-xs 2xl:text-sm text-slate-400">Investment summary</p>
                    </div>
            ...
            <div class="rounded-md border border-slate-200 bg-white p-5 ">
                <div class="mb-4 flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-0.5 text-xs 2xl:text-sm text-slate-400">Project overview</p>
                    </div>
        ...
        <section class="rounded-md border border-slate-200 bg-white p-5 ">
            <div class="mb-4 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-0.5 text-xs 2xl:text-sm text-slate-400">Approval request status</p>
                </div>

                <a href="{{ route('admin.approvals') }}" class="inline-flex w-fit cursor-pointer items-center gap-1.5 rounded-md border border-slate-300 bg-white px-3.5 py-2 text-xs 2xl:text-sm font-semibold text-slate-600 transition hover:bg-slate-50">
                    <i class="bi bi-arrow-left text-[11px]"></i>
                    View Approvals
                </a>
            </div>
