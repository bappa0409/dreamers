...
<head>
    ...
    <title>
        @yield('title', 'Dashboard') | Dreamers Association
    </title>
...
<div id="app" class="flex h-screen overflow-hidden">
    ...
    <aside
        id="sidebar"
        class="fixed inset-y-0 left-0 z-50 flex w-[250px] -translate-x-full flex-col
    ...
    >
        ...
        <div
            class="flex h-[76px] shrink-0 items-center border-b border-white/[0.08] px-4"
        >
            ...
            >
                ...
                <div
                    class="flex h-10 w-10 shrink-0 items-center justify-center
                           overflow-hidden rounded-md border border-white/70 bg-white"
                >

                    <div
                        class="flex h-full w-full items-center justify-center
                               bg-white text-lg font-black text-slate-950"
                    >
                        D
                    </div>
        ...
        >
            ...
            <div
                class="mb-2 px-3 pt-1 text-[10px] font-semibold
            ...
            <nav class="space-y-0.5">
                ...
                <a
                    href="{{ route('dashboard') }}"
                    class="menu-link group flex items-center gap-3 rounded-md px-3 py-1
            ...
            @if($hasSystemMenu)
                ...
                <div
                    class="my-4 border-t border-white/[0.07]"
                ></div>
                ...
                <nav class="space-y-0.5">
                    ...
                    @if($can('Role.view'))
                        ...
                        class="menu-link group flex items-center gap-3 rounded-md px-3 py-1 text-[13px] font-medium transition-all
        ...
        <div
            class="shrink-0 border-t border-white/[0.08] p-3"
        >
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <div
                        class="truncate text-[12px] font-semibold text-white"
                    >
                        {{ $authUser?->name ?? 'User' }}
                    </div>
                    ...
                    <div
                        class="mt-0.5 truncate text-[10px] text-sky-200/60"
                    >
    ...
    >
        ...
        <header
            class="z-30 h-[64px] shrink-0 border-b border-slate-200
                   bg-white shadow-[0_1px_3px_rgba(16,24,40,0.06)]"
        >

            <div
                class="flex h-full items-center justify-between px-4 sm:px-5 lg:px-6"
            >
                    ...
                    <div class="flex min-w-0 items-center gap-2">
                        ...
                        <span
                            class="h-2 w-2 shrink-0 rounded-full
                                   bg-gradient-to-br from-[#145da0] to-sky-400"
                        ></span>
                ...
                <div
                    class="relative flex shrink-0 items-center gap-2 sm:gap-3"
                >
                    ...
                    @if($can('Notification.view'))
                        ...
                        >
                            ...
                            <span
                                ...
                                class="absolute right-0.5 top-0.5 hidden min-w-[16px]
                                       rounded-full bg-red-500 px-1 text-center
                                       text-[9px] font-bold leading-4 text-white"
                            >
                                0
                            </span>
                    ...
                    <button
                        ...
                        class="group flex items-center gap-2 rounded-full
                    ...
                    >
                        ...
                        <i
                            class="bi bi-chevron-down hidden text-[10px]
                                   ...
                                   group-hover:text-slate-600 sm:block"
                        ></i>
                    ...
                    <div
                        id="userDropdown"
                        class="absolute right-0 top-[48px] z-50 hidden w-60
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                class="mt-1 truncate text-[10px] font-medium text-sky-600"
                            >
                        ...
                        <div class="p-1.5">
                            ...
                            >
                                ...
                                >
                                    <i
                                        class="bi bi-box-arrow-right text-sm"
                                    ></i>
        ...
        <main
            class="custom-scrollbar flex-1 overflow-y-auto bg-[#f4f6f9]"
        >

            <div
                class="min-h-full p-4 sm:p-5 lg:p-6"
            >
                ...
                @if(session('success'))
                    ...
                    <div
                        class="mb-4 rounded-md border border-emerald-200
                ...
                @if(session('error'))
                    ...
                    <div
                        class="mb-4 rounded-md border border-red-200
                               bg-red-50 px-4 py-3
