    ...
    <aside
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4">
            ...
            <div class="space-y-1">
                ...
                <a
                    href="{{ route('member.dashboard') }}"
                    class="group flex items-center gap-3 rounded-md px-3 py-2 text-xs font-semibold transition
...
<div class="space-y-1">
    ...
    <div>
        <button
            type="button"
            onclick="toggleMemberMenu('subscriptionMenu','subscriptionChevron')"
        ...
        <div
            id="subscriptionMenu"
            class="{{ $subscriptionOpen?'':'hidden' }} mt-1 space-y-1 pl-7">

            <a
                href="{{ route('member.subscriptions') }}"
                class="flex items-center gap-2 rounded-md px-3 py-1 text-[11px] font-medium transition
                {{ request()->routeIs('member.subscriptions')
                    ?'bg-sky-50 text-sky-700'
            ...
            <a
                href="{{ route('member.subscription-payments') }}"
                class="flex items-center gap-2 rounded-md px-3 py-1 text-[11px] font-medium transition
    ...
    <div>
        <button
            type="button"
            onclick="toggleMemberMenu('investmentMenu','investmentChevron')"
            class="group flex w-full items-center gap-3 rounded-md px-3 py-2 text-xs font-semibold transition
            {{ $investmentOpen
                ?'bg-sky-50 text-sky-700'
                :'text-slate-600 hover:bg-slate-50 hover:text-slate-800' }}">
        ...
        <div
            id="investmentMenu"
            class="{{ $investmentOpen?'':'hidden' }} mt-1 space-y-1 pl-7">

            <a
                href="{{ route('member.investments.active') }}"
                class="flex items-center gap-2 rounded-md px-3 py-1 text-[11px] font-medium transition
            ...
            <a
                href="{{ route('member.investments.completed') }}"
                class="flex items-center gap-2 rounded-md px-3 py-1 text-[11px] font-medium transition
