            ...
            <div class="reveal space-y-4 rounded-md border border-slate-200 bg-slate-50 p-6">
                <div>
                    <div class="flex items-center justify-between text-[12px]">
                        <span class="font-semibold text-xs text-slate-700">বিনিয়োগ</span>
                ...
                <div>
                    <div class="flex items-center justify-between text-[12px]">
                        <span class="font-semibold text-xs text-slate-700">জমি ও সম্পদ</span>
                ...
                <div>
                    <div class="flex items-center justify-between text-[12px]">
                        <span class="font-semibold text-xs text-slate-700">ব্যবসায়িক উদ্যোগ ও পণ্য</span>
                ...
                <div>
                    <div class="flex items-center justify-between text-[12px]">
                        <span class="font-semibold text-xs text-slate-700">সদস্য কল্যাণ তহবিল</span>
