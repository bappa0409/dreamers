...
Route::middleware('auth')->prefix('admin')->name('admin.')->controller(AdminController::class)->group(function () {
    ...
    Route::get('/nominees', 'nominees')->middleware('permission:Nominee.view')->name('nominees');
    Route::get('/member-exits', 'memberExits')->middleware('permission:MemberExit.view')->name('member-exits');

    // Welfare & Support
    Route::get('/welfare', 'welfare')->middleware('permission:Welfare.view')->name('welfare');
    Route::get('/feedback-support', 'feedbackSupport')->middleware('permission:FeedbackSupport.view')->name('feedback-support');
    ...
    Route::get('/loans', 'loans')->middleware('permission:Loan.view')->name('loans');
